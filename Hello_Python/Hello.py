...
print(q) # [11, 12, 13, 14, 15]

li = [1, 2, 3, 4]
q2 = list(map(lambda x: x*10, li))
print(q2)  # [10, 20, 30, 40]
...
lis = [1, 2, 3, 4]
q3 = list(filter(lambda x: not x%2, lis))
print(q3) # [2, 4]
